...
Plik z zadaniem zawiera projekt Angular z dodanymi bibliotekami Tailwind i FontAwesome (przy użyciu paczki FortAwesome)
Jest to szablon dla aplikacji ToDoList. Wykonaj w miarę możliwości jak największą ilość poniższych punktów.
